...
from slcsp_calc import SLCSPCalculator, app
...
class TestSLCSP:
    def test_indices_and_second_lowest(self, tmp_path: Path):
        ...
        # Input CSVs
        _write_csv(
            slcsp_p, [ref.SLCSP_ZIPCODE_COL, ref.OUT_HEADER_RATE], [["11111", ""]]
        )
        ...
        _write_csv(
            ...
            [
                ref.PLANS_STATE_COL,
                ref.PLANS_METAL_LEVEL_COL,
                ref.PLANS_RATE_COL,
                ref.PLANS_RATE_AREA_COL,
            ],
            [
                ["NY", "silver", "200.10", "1"],
    ...
    def test_ambiguous_zip_leaves_blank(self, tmp_path: Path):
        ...
        _write_csv(
            slcsp_p, [ref.SLCSP_ZIPCODE_COL, ref.OUT_HEADER_RATE], [["22222", ""]]
        )
    ...
    def test_less_than_two_silver_rates_blank(self, tmp_path: Path):
        ...
        _write_csv(
            slcsp_p, [ref.SLCSP_ZIPCODE_COL, ref.OUT_HEADER_RATE], [["33333", ""]]
        )
    ...
    def test_output_order_and_rounding(self, tmp_path: Path):
        ...
        _write_csv(
            slcsp_p,
            [ref.SLCSP_ZIPCODE_COL, ref.OUT_HEADER_RATE],
            [["99999", ""], ["11111", ""], ["77777", ""]],
        )
